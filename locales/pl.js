const messages = {
  ...
  "common.email": "Email",
  "nav.primaryLabel": "Główna nawigacja",
  "nav.mobileLabel": "Nawigacja mobilna",
  "nav.menu": "Menu",
  "nav.openMenu": "Otwórz menu nawigacji",
  "nav.closeMenu": "Zamknij menu nawigacji",
  "nav.createStory": "Stwórz bajkę",
  "nav.howItWorks": "Jak to działa",
  "nav.languageLearning": "Nauka języka",
  "nav.about": "O MoonTale",
  "nav.legal": "Dokumenty prawne",
  "nav.legalCenter": "Centrum prawne",
  "nav.privacyPolicy": "Polityka prywatności",
  "nav.termsOfUse": "Warunki korzystania",
  "nav.cookiePolicy": "Polityka cookies",
  "nav.ipPolicy": "Polityka własności intelektualnej",
  "nav.legalNotice": "Nota prawna",
  "nav.contact": "Kontakt",
